...
import { LucideAngularModule, Home, ChevronLeft, ChevronRight, User, Award, PawPrint,Users,SlidersHorizontal,Settings, ScrollText } from 'lucide-angular';
@Component({
  selector: 'app-menu',
 ...
 menuModel: MenuItem[] = [];
   ...
   readonly scrollTextIcon = ScrollText;
    ngOnInit() {
        ...
        this.menuModel = [
            { items: [{ label: 'Dashboard', icon: this.homeIcon, routerLink: ['Dashboard'] }] },
            { items:[{ label: 'Certificados', icon: this.scrollTextIcon, routerLink: ['Certificates']}] },
            { items:[{ label: 'Animales', icon: this.pawPrintIcon, routerLink: ['Animals']}] },
            { items:[{ label: 'Socios', icon: this.usersIcon, routerLink: ['Members']}]},
            {
                label: 'Configuración',
