...
export class Configuracion implements OnInit {
  ...
  loadParametros(): void {
    ...
    this.reproduccionService.getParametros(filters).subscribe({
      next: (response) => {
  ...
  saveParametro(): void {
    ...
    if (this.isEditing() && this.selectedParametro()) {
      // Actualizar
      this.reproduccionService.updateParametro(this.selectedParametro()!.id, data).subscribe({
        next: () => {
          this.messageService.add({
            severity: 'success',
            summary: 'Éxito',
      ...
      // Crear
      this.reproduccionService.createParametro(data).subscribe({
        next: () => {
          this.messageService.add({
            severity: 'success',
            summary: 'Éxito',
  ...
  deleteParametro(parametro: Parametro): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.reproduccionService.deleteParametro(parametro.id).subscribe({
          next: () => {
            this.messageService.add({
              severity: 'success',
              summary: 'Éxito',
