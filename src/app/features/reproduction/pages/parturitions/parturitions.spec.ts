...
import { Partos } from './parturitions';
...
describe('Partos', () => {
  let component: Partos;
  let fixture: ComponentFixture<Partos>;
  let reproductionService: jasmine.SpyObj<ReproductionService>;

  beforeEach(async () => {
    reproductionService = jasmine.createSpyObj('ReproductionService', [
      'getBirths', 'createBirth', 'updateBirth', 'deleteBirth'
    ]);
    reproductionService.getBirths.and.returnValue(of({ data: { data: [], total: 0 } } as any));
    ...
    await TestBed.configureTestingModule({
      imports: [Partos, NoopAnimationsModule],
      providers: [
        provideHttpClient(),
    ...
    fixture = TestBed.createComponent(Partos);
